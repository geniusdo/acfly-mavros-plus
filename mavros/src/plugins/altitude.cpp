...
public:
  explicit AltitudePlugin(plugin::UASPtr uas_) : Plugin(uas_, "altitude") {
    ...
    altitude_pub = node->create_publisher<mavros_msgs::msg::Altitude>(
        "altitude", sensor_qos);
  }
...
private:
  ...
  void handle_altitude(const mavlink::mavlink_message_t *msg [[maybe_unused]],
