...
static const std::unordered_map<
    typename std::underlying_type<MAV_COMPONENT>::type, const std::string>
    mav_comp_id_strings{{
        {0, "ALL"},
        {1, "AUTOPILOT1"},
        {25, "USER1"},
...
landing_target_type_from_str(const std::string &landing_target_type) {
  ...
  RCLCPP_ERROR_STREAM(logger, "TYPE: Unknown LANDING_TARGET_TYPE: "
                                  << landing_target_type
