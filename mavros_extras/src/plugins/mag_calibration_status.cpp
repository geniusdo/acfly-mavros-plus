...
public:
  explicit MagCalStatusPlugin(plugin::UASPtr uas_)
    ...
    mcr_pub = node->create_publisher<mavros_msgs::msg::MagnetometerReporter>(
        "~/report", 2);
  }
...
private:
  ...
  void handle_status(const mavlink::mavlink_message_t *msg [[maybe_unused]],
  ...
  void handle_report(const mavlink::mavlink_message_t *msg [[maybe_unused]],
