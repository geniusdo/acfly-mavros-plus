...
public:
  explicit GpsStatusPlugin(plugin::UASPtr uas_) : Plugin(uas_, "gpsstatus") {
    gps1_raw_pub =
        node->create_publisher<mavros_msgs::msg::GPSRAW>("~/gps1/raw", 10);
    gps2_raw_pub =
        node->create_publisher<mavros_msgs::msg::GPSRAW>("~/gps2/raw", 10);
    gps1_rtk_pub =
        node->create_publisher<mavros_msgs::msg::GPSRTK>("~/gps1/rtk", 10);
    gps2_rtk_pub =
        node->create_publisher<mavros_msgs::msg::GPSRTK>("~/gps2/rtk", 10);
  }

  Subscriptions get_subscriptions() override {
    return {make_handler(&GpsStatusPlugin::handle_gps_raw_int),
...
private:
  ...
  /**
   * @brief Publish <a
   * href="https://mavlink.io/en/messages/common.html#GPS_RAW_INT">mavlink
  ...
  void handle_gps_raw_int(const mavlink::mavlink_message_t *msg
    ...
    ros_msg.dgps_numch =
        UINT8_MAX; // information not available in GPS_RAW_INT mavlink message
    ros_msg.dgps_age =
        UINT32_MAX; // information not available in GPS_RAW_INT mavlink message
  ...
  /**
   * @brief Publish <a
   * href="https://mavlink.io/en/messages/common.html#GPS2_RAW">mavlink GPS2_RAW
   * message</a> into the gps2/raw topic.
   */
  void handle_gps2_raw(const mavlink::mavlink_message_t *msg [[maybe_unused]],
  ...
  template <typename MMsg> mavros_msgs::msg::GPSRTK convert_rtk(MMsg mav_msg) {
    ...
    switch (static_cast<RTK_BASELINE_COORDINATE_SYSTEM>(
    ...
    ros_msg.header = uas->synchronized_header(
        frame_id, mav_msg.time_last_baseline_ms * 1000);
  ...
  /**
   * @brief Publish <a
   * href="https://mavlink.io/en/messages/common.html#GPS_RTK">mavlink GPS_RTK
   * message</a> into the gps1/rtk topic.
   */
  void handle_gps_rtk(const mavlink::mavlink_message_t *msg [[maybe_unused]],
  ...
  /**
   * @brief Publish <a
   * href="https://mavlink.io/en/messages/common.html#GPS2_RTK">mavlink GPS2_RTK
   * message</a> into the gps2/rtk topic.
   */
  void handle_gps2_rtk(const mavlink::mavlink_message_t *msg [[maybe_unused]],
