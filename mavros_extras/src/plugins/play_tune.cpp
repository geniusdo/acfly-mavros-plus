...
public:
  explicit PlayTunePlugin(plugin::UASPtr uas_) : Plugin(uas_, "play_tune") {
    sub = node->create_subscription<mavros_msgs::msg::PlayTuneV2>(
        "play_tune", 1, std::bind(&PlayTunePlugin::callback, this, _1));
  }
