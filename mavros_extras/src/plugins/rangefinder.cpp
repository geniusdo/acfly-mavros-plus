 ...
 * @plugin rangefinder
 *
 * This plugin allows publishing rangefinder sensor data from Ardupilot FCU to
 * ROS.
 */
...
public:
  explicit RangefinderPlugin(plugin::UASPtr uas_)
    ...
    rangefinder_pub =
        node->create_publisher<sensor_msgs::msg::Range>("~/rangefinder", 10);
  }

  Subscriptions get_subscriptions() override {
    return {make_handler(&RangefinderPlugin::handle_rangefinder)};
  }
