 ...
 *
 * Sends <a
 * href="https://mavlink.io/en/messages/common.html#GPS_INPUT">GPS_INPUT MAVLink
 * messages</a>
 */
class GpsInputPlugin : public plugin::Plugin {
public:
  explicit GpsInputPlugin(plugin::UASPtr uas_) : Plugin(uas_, "gps_input") {
    ...
    gps_input_sub = node->create_subscription<mavros_msgs::msg::GPSINPUT>(
        "~/gps_input", 1, std::bind(&GpsInputPlugin::send_cb, this, _1));
  }
