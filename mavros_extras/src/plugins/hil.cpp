/*
 * Copyright 2016,2017 Mohamed Abdelkader, Nuno Marques, Pavel Vechersky, Beat
 * Küng.
 *
...
public:
  ...
  explicit HilPlugin(plugin::UASPtr uas_) : Plugin(uas_, "hil") {
    hil_state_quaternion_sub =
        node->create_subscription<mavros_msgs::msg::HilStateQuaternion>(
            "~/state", 10, std::bind(&HilPlugin::state_quat_cb, this, _1));
    hil_gps_sub = node->create_subscription<mavros_msgs::msg::HilGPS>(
        "~/gps", 10, std::bind(&HilPlugin::gps_cb, this, _1));
    hil_sensor_sub = node->create_subscription<mavros_msgs::msg::HilSensor>(
        "~/imu_ned", 10, std::bind(&HilPlugin::sensor_cb, this, _1));
    hil_flow_sub = node->create_subscription<mavros_msgs::msg::OpticalFlowRad>(
        "~/optical_flow", 10, std::bind(&HilPlugin::optical_flow_cb, this, _1));
    hil_rcin_sub = node->create_subscription<mavros_msgs::msg::RCIn>(
        "~/rc_inputs", 10, std::bind(&HilPlugin::rcin_raw_cb, this, _1));

    hil_controls_pub =
        node->create_publisher<mavros_msgs::msg::HilControls>("~/controls", 10);
    hil_actuator_controls_pub =
        node->create_publisher<mavros_msgs::msg::HilActuatorControls>(
...
private:
  ...
  rclcpp::Publisher<mavros_msgs::msg::HilActuatorControls>::SharedPtr
      hil_actuator_controls_pub;

  rclcpp::Subscription<mavros_msgs::msg::HilStateQuaternion>::SharedPtr
      hil_state_quaternion_sub;
  ...
  rclcpp::Subscription<mavros_msgs::msg::OpticalFlowRad>::SharedPtr
      hil_flow_sub;
  ...
  void handle_hil_controls(const mavlink::mavlink_message_t *msg
    ...
    hil_controls_msg.header.stamp =
        uas->synchronise_stamp(hil_controls.time_usec);
    // [[[cog:
    // for f in (
  ...
  void handle_hil_actuator_controls(
    ...
    hil_actuator_controls_msg.header.stamp =
        uas->synchronise_stamp(hil_actuator_controls.time_usec);
    const auto &arr = hil_actuator_controls.controls;
    std::copy(arr.cbegin(), arr.cend(),
              hil_actuator_controls_msg.controls.begin());
   ...
   */
  void
  state_quat_cb(const mavros_msgs::msg::HilStateQuaternion::SharedPtr req) {
    ...
    // WRT world frame
    auto ang_vel =
        ftf::transform_frame_enu_ned(ftf::transform_frame_baselink_aircraft(
            ftf::to_eigen(req->angular_velocity)));
    auto lin_vel = ftf::transform_frame_enu_ned<Eigen::Vector3d>(
                       ftf::to_eigen(req->linear_velocity)) *
                   1E2;
  ...
  void sensor_cb(const mavros_msgs::msg::HilSensor::SharedPtr req) {
    ...
    // WRT world frame
    auto acc = ftf::transform_frame_baselink_aircraft(ftf::to_eigen(req->acc));
    auto gyro =
        ftf::transform_frame_baselink_aircraft(ftf::to_eigen(req->gyro));
  ...
  void optical_flow_cb(const mavros_msgs::msg::OpticalFlowRad::SharedPtr req) {
    ...
    auto int_xy = ftf::transform_frame_aircraft_baselink(
        Eigen::Vector3d(req->integrated_x, req->integrated_y, 0.0));
    auto int_gyro = ftf::transform_frame_aircraft_baselink(Eigen::Vector3d(
        req->integrated_xgyro, req->integrated_ygyro, req->integrated_zgyro));
   ...
   * Message specification: @p
   * https://mavlink.io/en/messages/common.html#HIL_RC_INPUTS_RAW
   */
  void rcin_raw_cb(const mavros_msgs::msg::RCIn::SharedPtr req) {
    ...
    std::copy(req->channels.begin(), req->channels.begin() + n,
              channels.begin());
